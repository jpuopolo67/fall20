...
| 6 | Lambdas, Java FX & GUI Basics | Ch. 14 | *Chess* project overview |
| 7 | Generics, Collections | Ch. 19 | *Chessman* & *Board* classes, render *Board* |
| 8 | Collections & Iterators| Ch. 20 | *Pawn* & *Rook* classes, render starting positions  |
| 9 | Queues, Sets, Maps | Ch. 20-21 | *Knight* & *Bishop* classes, render starting positions |
| 10 | Recursion | Ch. 18 | *Queen* & *King* classes, render starting positions |
| 11 | Exam 2 Review | Prepare exam notes | Exam 2 (2nd class) |
| 12 | Basics of Functional Programming & Streams API | Class Notes | Add *Game* and *Player* |
| 13 | Project Consulting | *None* | Add GUI piece movement, 2 humans can play on same computer|
| 14 | Java Networking | *None* | EXTRA CREDIT: Add Chess server for remote play |
| 15 | Project Consulting | *None* | EXTRA CREDIT: Add saving and loading of games |
